import { ReactElement, RefObject, ElementType, Dispatch, MutableRefObject, Context, HTMLAttributes, ReactNode, ForwardRefExoticComponent, RefAttributes, FC, MemoExoticComponent, NamedExoticComponent, Reducer, Component, MouseEvent } from 'react';
...
declare const ColumnHeaderItem: MemoExoticComponent<({ column, colIndex, isDragging, isResizing, separatorProps, sortDirection, sortIndex, options, }: ColumnHeaderItemProps) => JSX.Element>;
